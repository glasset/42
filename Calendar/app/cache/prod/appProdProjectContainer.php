...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_48e73ba4b27258fc6e9642d6f993b6048109c434f0779035b0c9329cf7cda177');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_48e73ba4b27258fc6e9642d6f993b6048109c434f0779035b0c9329cf7cda177');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_48e73ba4b27258fc6e9642d6f993b6048109c434f0779035b0c9329cf7cda177');
        ...
        $d->setProxyDir('/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod',
            ...
            'session.save_path' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/sessions',
            ...
            'router.resource' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/glasset/Documents/mamp/apps/frame/htdocs/app/cache/prod/doctrine/orm/Proxies',
