...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_10f2f3db18cb8f668a134b3a6a473109cf2326fe31e34ca968cddcfe678651c8');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_10f2f3db18cb8f668a134b3a6a473109cf2326fe31e34ca968cddcfe678651c8');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_10f2f3db18cb8f668a134b3a6a473109cf2326fe31e34ca968cddcfe678651c8');
        ...
        $d->setProxyDir('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/Resources/views');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod',
            'kernel.logs_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/logs',
            ...
            'session.save_path' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/../web',
            'assetic.write_to' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/../web',
            'assetic.variables' => array(
            ),
            'assetic.java.bin' => '/usr/bin/java',
            'assetic.node.bin' => '/usr/bin/node',
            'assetic.ruby.bin' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/ruby/bin/ruby',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/fcorbel/MAMP/apps/Symfony/htdocs/app/cache/prod/doctrine/orm/Proxies',
